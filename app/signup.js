...
export default function Signup() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView contentContainerClassName="flex-row px-6 py-10 mt-10">
      ...
      <TouchableOpacity
        ...
        onPress={pickImage}
      >
        <Text className="text-white font-semibold">Pick an Image</Text>
      </TouchableOpacity>

     
        <Image
        source={require('../assets/logo1.jpeg')}
          className="w-48 h-48 mt-5 rounded-2xl"
        />
