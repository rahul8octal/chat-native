...
export default function Status() {
  ...
  return (
      ...
      <View className="   space-y-6 mb-5  mt-10">
       
       <View className="flex-row items-center px-4 py-3 border-b border-gray-300 justify-between ml-2">
        <View>
          <TouchableOpacity
            onPress={() => router.back()}
          ...
          >
            ...
            <Text className="text-xl">Updates</Text>
          </TouchableOpacity>
        </View>
   ...
   <View className=" ml-4">
      ...
      <Text className="text-xl text-gray-500">
        ...
        <View className="w-36  rounded-3xl ml-5 mt-5 flex-row">
        
                 <TouchableOpacity
                   onPress={pickImage}
                   activeOpacity={0.8}
                   className="border border-dashed border-indigo-300 rounded-2xl p-3  items-center  "
                 >
                   {user.profile_picture ? (
                     ...
                     />
                      ...
                      <View className="w-16 h-16  rounded-full bg-indigo-100 items-center justify-center mt-3">
  ...
  <View className="w-16 h-16 rounded-full overflow-hidden relative">
    ...
    {/* Add Icon */}
    <View className="absolute bottom-0 right-0 w-6 h-6 rounded-full bg-green-600 items-center justify-center">
  ...
  <View className="ml-4">
    ...
    <Text className="text-gray-500">Tap to add status</Text>
  </View>
</View>
